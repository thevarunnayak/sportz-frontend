            ...
            <div className="grid md:grid-cols-2 gap-8 text-sm text-gray-600">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    REST URL: <code className="bg-gray-100 px-1 rounded">{API_BASE_URL}</code>
                  </li>
                  <li>
                    WS URL: <code className="bg-gray-100 px-1 rounded">{WS_BASE_URL}</code>
                  </li>
              ...
              <div>
                ...
                <p>
                  3. Wait for <code className="text-xs bg-gray-100 p-0.5 border border-gray-300 rounded">score_update</code> or <code className="text-xs bg-gray-100 p-0.5 border border-gray-300 rounded">commentary</code> events from the server. The card score updates instantly, and the right panel fills with text.
                </p>
              </div>
            </div>
          </div>
